namespace CPVI
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            txtCantidad.ForeColor = Color.Maroon;
            ...
            // btnEstablecer
            // 
            btnEstablecer.BackColor = Color.FromArgb(255, 192, 192);
            btnEstablecer.Font = new Font("Tahoma", 9F, FontStyle.Bold, GraphicsUnit.Point, 0);
            btnEstablecer.ForeColor = Color.Maroon;
            ...
            lbImprimir.ForeColor = Color.Maroon;
            ...
            txtEdad.ForeColor = Color.Maroon;
            txtEdad.Location = new Point(21, 261);
            txtEdad.Margin = new Padding(3, 4, 3, 4);
            txtEdad.Name = "txtEdad";
            txtEdad.Size = new Size(72, 26);
            txtEdad.TabIndex = 7;
            // 
            // txtNombre
            // 
            txtNombre.Font = new Font("Tahoma", 9F, FontStyle.Bold);
            txtNombre.ForeColor = Color.Maroon;
            txtNombre.Location = new Point(21, 197);
            ...
            txtId.ForeColor = Color.Maroon;
            txtId.Location = new Point(21, 131);
            txtId.Margin = new Padding(3, 4, 3, 4);
            txtId.Name = "txtId";
            txtId.Size = new Size(72, 26);
            txtId.TabIndex = 9;
            // 
            // btnMostrar
            // 
            btnMostrar.BackColor = Color.FromArgb(255, 192, 192);
            btnMostrar.Font = new Font("Tahoma", 9F, FontStyle.Bold, GraphicsUnit.Point, 0);
            btnMostrar.ForeColor = Color.Maroon;
            ...
            // btnActualizar
            // 
            btnActualizar.BackColor = Color.FromArgb(255, 192, 192);
            btnActualizar.Font = new Font("Tahoma", 9F, FontStyle.Bold);
            btnActualizar.ForeColor = Color.Maroon;
            btnActualizar.Location = new Point(466, 192);
            ...
            btnBorrar.ForeColor = Color.Maroon;
            btnBorrar.Location = new Point(484, 131);
            ...
            // btnIngresar
            // 
            btnIngresar.BackColor = Color.FromArgb(255, 192, 192);
            btnIngresar.Font = new Font("Tahoma", 9F, FontStyle.Bold);
            btnIngresar.ForeColor = Color.Maroon;
            btnIngresar.Location = new Point(31, 306);
            ...
            btnBuscar.ForeColor = Color.Maroon;
            btnBuscar.Location = new Point(484, 256);
